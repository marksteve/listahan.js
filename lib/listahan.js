...
(function() {
  ...
  $.fn.listahan = function() {
    var $menu, $root, $submenus, addMenuItem, hideMenus, item, items, menuTimeout, options, optionsOrMethod, params, showMenu, _i, _j, _len, _len1, _ref, _ref1;
    ...
    showMenu = function(item, $item) {
      var $submenu, botOverflow, left, outerHeight, overflow, parentLeft, parentOffset, parentTop, rightOverflow, submenuBorderBot, submenuBorderTop, top, topOverflow;
      ...
      if ($submenu && !$submenu.is(":visible")) {
        ...
        if (rightOverflow > 0) {
          $submenu.addClass("left").offset({
            left: $item.offset().left - $submenu.outerWidth()
          });
        }
        ...
        if (botOverflow > 0) {
          ...
          if (topOverflow > 0 && botOverflow > 0) {
            return $submenu.height($submenu.outerHeight() - overflow).css("overflow-y", "scroll");
          }
        }
      }
    };
    ...
    addMenuItem = function(item) {
      ...
      $menuItem = $("<li/>").attr("id", item.id).data("item", item).on("mouseenter", function(e) {
        ...
        while (parent != null) {
          ...
          $parent = $("li#" + parent, $menu).addClass("active");
