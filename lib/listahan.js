...
(function() {
  ...
  $.fn.listahan = function() {
    ...
    showMenu = function(item, $item) {
      var $submenu, alignLeft, alignRight, botOverflow, outerHeight, overflow, parentLeft, parentOffset, parentTop, rightOverflow, submenuBorderBot, submenuBorderTop, top, topOverflow;
